...
class ObjectWrapper:
    ...
    def __init__(self, parent: CatalogWrapper, row: int):
        self._parent = parent
        self._magnitudes, self._magnitude_errors, self._redshift_estimates, self._true_redshift, self._input_data = self._parent.get_data(row)
...
class MultiObjectWapper(ObjectWrapper):
    ...
    def __init__(            
        ...
        row: int,
        objects: dict[str, ObjectWrapper]
    ) -> None:
...
class MultiCatalogWrapper(CatalogWrapper):
    ...
    def __init__(self, matched_catalog: CatalogWrapper, component_catalogs: dict[str, CatalogWrapper]) -> None:
